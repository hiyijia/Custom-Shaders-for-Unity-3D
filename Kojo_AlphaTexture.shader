...
Shader "Custom/Kojo_AlphaTexture"
{
	Properties
	{
		...
		_SpecPower("Specular Power", Range(0,1)) = 0.5 // Set Spec Shine along a range. Defaults at 0.5
		_Cutoff("Alpha Cutoff", Range(0,1)) = 0.5  // Set the Alpha Channel along a range. Defaults at 0.5
	}
